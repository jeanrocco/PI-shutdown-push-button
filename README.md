...
Now I didn't devised this setup, the credit all goes to [GIMX](https://gimx.fr/wiki/index.php?title=RPi#Autostart_GIMX_at_boot_without_GUI) where I found it. A small advertisement here: GIMX is a cool project that allows old gamers, like me, to use the mouse/keyboard to play games on the PlayStation or XBox. And guess what, it uses all the toys I like, Arduino and Raspberry PI. 
